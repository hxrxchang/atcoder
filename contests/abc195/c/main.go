...
func solve() {
	...
	if n >= pow(10, 3) {
        limit := min(n, pow(10, 6) - 1)
        result += (limit - 999) * 1
    }
    if n >= pow(10, 6) {
        limit := min(n, pow(10, 9) - 1)
        result += (limit - 999999) * 2
    }
    if n >= pow(10, 9) {
        limit := min(n, pow(10, 12) - 1)
        result += (limit - 999999999) * 3
    }

	if n >= pow(10, 12) {
		limit := min(n, pow(10, 15) - 1)
		result += (limit - 999999999999) * 4
	}
